...
- `GET ?action=confirmer|desinscrire&t=…` → page à **bouton**, en lecture seule : les antivirus d'entreprise ouvrent les liens des e-mails, un GET qui agirait confirmerait ou désinscrirait à l'insu du lecteur. `POST` (le bouton, ou la désinscription **en un clic** des messageries, RFC 8058) fait la transition.
...
├── refonte-site-internet.html / website-redesign.html   # Offre refonte (FR/EN)
