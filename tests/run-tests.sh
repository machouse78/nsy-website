...
docker run --rm -v "$PWD:/app" php:8.3-cli-alpine sh -c 'php -l /app/chat.php && php -l /app/contact.php && php -l /app/faisabilite.php && php -l /app/antispam.php && php -l /app/formulaires.php && php -l /app/journal-stats.php' | sed 's/^/  ✓ /'
